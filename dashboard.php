      ...
      <?php
         ...
         <div class="card">
            ...
            <?php 
             ...
             $sts=  $row['status'];
               if($sts == "terpakai"){
                  echo '<a href="#" class="btn btn-secondary disabled" tabindex="-1" aria-disabled="true" role="button" data-bs-toggle="button">Lapangan Terpakai</a>';
               }else{
                  echo '<a href="checkin.php?nama_lapangan=' . $row["nama_lapangan"] . '&username=' . $username . '"><button type="button" class="btn btn-dark">Sewa</button></a>';
               }
            ?>
         </div>
      <?php 
